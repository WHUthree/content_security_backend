...
import com.three.contentsecuritybackend.common.DeleteRequest;
import com.three.contentsecuritybackend.constant.UserConstant;
import com.three.contentsecuritybackend.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@ModelAttribute UserRegisterRequest userRegisterRequest) {
        ThrowUtils.throwIf(userRegisterRequest == null, ErrorCode.PARAMS_ERROR);
        String schoolId = userRegisterRequest.getSchoolId();
        String userName = userRegisterRequest.getUserName();
        String userPassword = userRegisterRequest.getUserPassword();
        String checkPassword = userRegisterRequest.getCheckPassword();
        MultipartFile file = userRegisterRequest.getFile();
        long result = userService.userRegister(schoolId, userName, userPassword, checkPassword, file);
    ...
    public BaseResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest, HttpServletRequest request) {
        ...
        String schoolId = userLoginRequest.getSchoolId();
        String userPassword = userLoginRequest.getUserPassword();
        if (StringUtils.isAnyBlank(schoolId, userPassword)) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        LoginUserVO loginUserVO = userService.userLogin(schoolId, userPassword, request);
